...
import { ADD_MOVIE_MUTATION, FETCH_MOVIES } from "../graphql";
...
const AddMovie = () => {
  ...
  const handleSubmit = (e) => {
    ...
    addMovie({
      variables: {
        addMovieTitle: title,
        addMovieOverview: overview,
        addMoviePosterPath: path,
        addMoviePopularity: Number(popularity),
        addMovieTaqs: tags.split(","),
      },
    });
